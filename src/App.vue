...
import { ref } from "vue";
import { greet as greetApi, formatInvokeError, loadTelegramMock } from "@/platform/api";
...
async function greet() {
  try {
    ...
    greetMsg.value = formatInvokeError(error);
  }
}
...
async function useTelegramMock() {
  ...
  try {
    ...
    telegramError.value = formatInvokeError(error);
  } finally {
...
<template>
  <main class="container">
    ...
    <pre v-if="telegramReport" class="telegram-report">{{
      telegramReport
    }}</pre>
  </main>
</template>
